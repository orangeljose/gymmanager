...
# Importar blueprints
from routes import auth_bp, clients_bp, payments_bp, reports_bp, branches_bp, plans_bp, payment_accounts_bp, exchange_bp, users_bp, invitations_bp, businesses_bp
