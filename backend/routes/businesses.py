...
def delete_business(business_id):
    ...
    try:
        ...
        if not business:
            return jsonify({
                'success': False,
                'error': {'code': 404, 'message': 'Negocio no encontrado'}
            }), 404
        ...
        return jsonify({
            'success': False,
            'error': {'code': 500, 'message': 'Error al eliminar negocio'}
        }), 500
...
def update_business(business_id):
    ...
    try:
        ...
        if not name:
            return jsonify({
                'success': False,
                'error': {'code': 400, 'message': 'El nombre es requerido'}
            }), 400
        ...
        # Permisos: super_admin puede actualizar cualquier negocio,
        ...
        if success:
            ...
            return jsonify({
                'success': True,
                'data': {'id': business_id, 'name': name}
            }), 200

        return jsonify({
            'success': False,
            'error': {'code': 500, 'message': 'Error al actualizar negocio'}
        }), 500
